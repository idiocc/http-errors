...
export const HTTPErrors = {
  ...
  'supports err instanceof Error'() {
    ok(createError(404) instanceof Error)
    ok((new createError['404']()) instanceof Error)
    ok((new createError['500']()) instanceof Error)
  },
  'supports err instanceof exposed constructor'() {
    ok(createError(404) instanceof createError.NotFound)
    ok(createError(500) instanceof createError.InternalServerError)
    ok((new createError['404']()) instanceof createError.NotFound)
    ok((new createError['500']()) instanceof createError.InternalServerError)
    ok((new createError.NotFound()) instanceof createError.NotFound)
  ...
  'supports isError()'() {
    ...
    ok(isError(createError(404)))
    ok(isError(new createError['404']()))
    ok(isError(new createError['500']()))
